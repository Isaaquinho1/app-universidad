...
LessonReactionSummary _$LessonReactionSummaryFromJson(
    ...
    LessonReactionSummary(
      ...
      reactionCounts: (json['reactionCounts'] as Map<String, dynamic>).map(
        (k, e) => MapEntry($enumDecode(_$ReactionTypeEnumMap, k), e as int),
      ),
      userReaction:
          $enumDecodeNullable(_$ReactionTypeEnumMap, json['userReaction']),
    );
...
Map<String, dynamic> _$LessonReactionSummaryToJson(
    ...
    <String, dynamic>{
      ...
      'reactionCounts': instance.reactionCounts
          .map((k, e) => MapEntry(_$ReactionTypeEnumMap[k]!, e)),
