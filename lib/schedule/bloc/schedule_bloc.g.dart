...
_$ScheduleStateImpl _$$ScheduleStateImplFromJson(Map<String, dynamic> json) =>
    _$ScheduleStateImpl(
      ...
      comments: (json['comments'] as List<dynamic>?)
              ...
              .toList() ??
          const [],
      reactionSummaries: (json['reactionSummaries'] as List<dynamic>?)
              ?.map((e) =>
                  LessonReactionSummary.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
...
Map<String, dynamic> _$$ScheduleStateImplToJson(_$ScheduleStateImpl instance) =>
    <String, dynamic>{
