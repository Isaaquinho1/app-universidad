...
class AdminRoleManagementRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, GoRouterState state) {
    return const AdminRoleManagementPage();
  }
}

class AdminStudentIdValidatorRoute extends GoRouteData {
  const AdminStudentIdValidatorRoute();

  @override
  Widget build(BuildContext context, GoRouterState state) {
    return const AdminStudentIdValidatorPage();
  }
}
...
class StudentIdRoute extends GoRouteData {
  const StudentIdRoute();
